...
Banco banco1 = new Banco("Banco Caixa", 1);

//recebe numero, cep, telefone e banco
Agencia agencia1 = new Agencia(101, "12345-678", "(24) 987654321", banco1);
Agencia agencia2 = new Agencia(102, "98765-432", "(24) 876543210", banco1);
Agencia agencia3 = new Agencia(103, "55555-000", "(24) 111222333", banco1);

// recebe nome, cpf e idade
Cliente cliente1 = new Cliente("Bruna", "11122233344", 19);
Cliente cliente2 = new Cliente("Brenda", "55566677788", 19);
...
Conta conta1 = new Conta(2024101001, 200, cliente1, agencia1);
Conta conta2 = new Conta(2024101002, 50, cliente2, agencia2);
Conta conta3 = new Conta(654987, 2341.42m, cliente3, agencia3);
